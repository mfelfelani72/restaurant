...
function TestmonialLandingPage() {
    return (
        <div className='ml-auto mr-auto max-w-7xl pl-6 pr-6 lg:pl-8 lg:pr-8 pt-4 pb-10 '>

            <div className='ml-auto mr-auto max-w-xl text-center'>
            ...
            <div className='ml-auto mr-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900/100 sm:mt-20 sm:grid-cols-2 xl:ml-0 xl:mr-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4 bg-white/100'>
